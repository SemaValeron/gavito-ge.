...
export default function Page() {
  ...
  const CATEGORIES = [
    ...
    // Обновленное название категории "Красота"
    { id: 'beauty', name: 'თავის მოვლა და პარფიუმერია', icon: '✨' },
    { id: 'sport', name: 'სპორტი და დასვენება', icon: '⚽' },
  ...
  const MARKET_DATA = {
    ...
    'macbook': 4000,
    'airpods': 600,
    'dyson': 1500 // Добавил популярный товар для категории красоты
  };
